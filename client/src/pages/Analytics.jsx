...
const CLIENT_AUTO_SYNC_ENABLED = String(
  import.meta.env.VITE_ANALYTICS_CLIENT_AUTO_SYNC_ENABLED || 'true'
).toLowerCase() === 'true';
const AUTO_SYNC_INTERVAL_MS = Number(import.meta.env.VITE_ANALYTICS_AUTO_SYNC_MS || 2 * 60 * 1000);
const AUTO_SYNC_INITIAL_DELAY_MS = Number(import.meta.env.VITE_ANALYTICS_AUTO_SYNC_INITIAL_DELAY_MS || 10000);
const AUTO_REFRESH_INTERVAL_MS = Number(import.meta.env.VITE_ANALYTICS_AUTO_REFRESH_MS || 45000);
